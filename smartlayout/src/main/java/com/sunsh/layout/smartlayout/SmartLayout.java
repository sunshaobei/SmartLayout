package com.sunsh.layout.smartlayout;
...
import com.sunsh.layout.smartlayout.api.DefaultRefreshFooterCreater;
import com.sunsh.layout.smartlayout.api.DefaultRefreshHeaderCreater;
import com.sunsh.layout.smartlayout.api.RefreshContent;
...
import com.sunsh.layout.smartlayout.api.ScrollBoundaryDecider;
import com.sunsh.layout.smartlayout.constant.DimensionStatus;
import com.sunsh.layout.smartlayout.constant.RefreshState;
import com.sunsh.layout.smartlayout.constant.SpinnerStyle;
import com.sunsh.layout.smartlayout.footer.BallPulseFooter;
import com.sunsh.layout.smartlayout.header.BezierRadarHeader;
import com.sunsh.layout.smartlayout.header.FalsifyHeader;
import com.sunsh.layout.smartlayout.impl.RefreshContentWrapper;
import com.sunsh.layout.smartlayout.impl.RefreshFooterWrapper;
import com.sunsh.layout.smartlayout.impl.RefreshHeaderWrapper;
import com.sunsh.layout.smartlayout.listener.OnLoadmoreListener;
import com.sunsh.layout.smartlayout.listener.OnMultiPurposeListener;
import com.sunsh.layout.smartlayout.listener.OnRefreshListener;
import com.sunsh.layout.smartlayout.listener.OnRefreshLoadmoreListener;
import com.sunsh.layout.smartlayout.util.DelayedRunable;
import com.sunsh.layout.smartlayout.util.DensityUtil;
import com.sunsh.layout.smartlayout.util.ViscousFluidInterpolator;
...
/**
 * 智能刷新布局
 * Created by sunsh on 2017/11/20.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class SmartLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent, NestedScrollingChild {
...
//    protected boolean mIsSkipContentLayout;
    ...
    public SmartLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.initView(context, attrs);
    }

    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    public SmartLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.SmartLayout);

        ViewCompat.setNestedScrollingEnabled(this, ta.getBoolean(R.styleable.SmartLayout_srlEnableNestedScrolling, false));
        mDragRate = ta.getFloat(R.styleable.SmartLayout_srlDragRate, mDragRate);
        mHeaderMaxDragRate = ta.getFloat(R.styleable.SmartLayout_srlHeaderMaxDragRate, mHeaderMaxDragRate);
        mFooterMaxDragRate = ta.getFloat(R.styleable.SmartLayout_srlFooterMaxDragRate, mFooterMaxDragRate);
        mHeaderTriggerRate = ta.getFloat(R.styleable.SmartLayout_srlHeaderTriggerRate, mHeaderTriggerRate);
        mFooterTriggerRate = ta.getFloat(R.styleable.SmartLayout_srlFooterTriggerRate, mFooterTriggerRate);
        mEnableRefresh = ta.getBoolean(R.styleable.SmartLayout_srlEnableRefresh, mEnableRefresh);
        mReboundDuration = ta.getInt(R.styleable.SmartLayout_srlReboundDuration, mReboundDuration);
        mEnableLoadmore = ta.getBoolean(R.styleable.SmartLayout_srlEnableLoadmore, mEnableLoadmore);
        mHeaderHeight = ta.getDimensionPixelOffset(R.styleable.SmartLayout_srlHeaderHeight, density.dip2px(100));
        mFooterHeight = ta.getDimensionPixelOffset(R.styleable.SmartLayout_srlFooterHeight, density.dip2px(60));
        mDisableContentWhenRefresh = ta.getBoolean(R.styleable.SmartLayout_srlDisableContentWhenRefresh, mDisableContentWhenRefresh);
        mDisableContentWhenLoading = ta.getBoolean(R.styleable.SmartLayout_srlDisableContentWhenLoading, mDisableContentWhenLoading);
        mEnableHeaderTranslationContent = ta.getBoolean(R.styleable.SmartLayout_srlEnableHeaderTranslationContent, mEnableHeaderTranslationContent);
        mEnableFooterTranslationContent = ta.getBoolean(R.styleable.SmartLayout_srlEnableFooterTranslationContent, mEnableFooterTranslationContent);
        mEnablePreviewInEditMode = ta.getBoolean(R.styleable.SmartLayout_srlEnablePreviewInEditMode, mEnablePreviewInEditMode);
        mEnableAutoLoadmore = ta.getBoolean(R.styleable.SmartLayout_srlEnableAutoLoadmore, mEnableAutoLoadmore);
        mEnableOverScrollBounce = ta.getBoolean(R.styleable.SmartLayout_srlEnableOverScrollBounce, mEnableOverScrollBounce);
        mEnablePureScrollMode = ta.getBoolean(R.styleable.SmartLayout_srlEnablePureScrollMode, mEnablePureScrollMode);
        mEnableScrollContentWhenLoaded = ta.getBoolean(R.styleable.SmartLayout_srlEnableScrollContentWhenLoaded, mEnableScrollContentWhenLoaded);
        mEnableLoadmoreWhenContentNotFull = ta.getBoolean(R.styleable.SmartLayout_srlEnableLoadmoreWhenContentNotFull, mEnableLoadmoreWhenContentNotFull);
        mEnableFooterFollowWhenLoadFinished = ta.getBoolean(R.styleable.SmartLayout_srlEnableFooterFollowWhenLoadFinished, mEnableFooterFollowWhenLoadFinished);
        mEnableOverScrollDrag = ta.getBoolean(R.styleable.SmartLayout_srlEnableOverScrollDrag, mEnableOverScrollDrag);
        mFixedHeaderViewId = ta.getResourceId(R.styleable.SmartLayout_srlFixedHeaderViewId, View.NO_ID);
        mFixedFooterViewId = ta.getResourceId(R.styleable.SmartLayout_srlFixedFooterViewId, View.NO_ID);

        mManualLoadmore = ta.hasValue(R.styleable.SmartLayout_srlEnableLoadmore);
        mManualNestedScrolling = ta.hasValue(R.styleable.SmartLayout_srlEnableNestedScrolling);
        mHeaderHeightStatus = ta.hasValue(R.styleable.SmartLayout_srlHeaderHeight) ? DimensionStatus.XmlLayoutUnNotify : mHeaderHeightStatus;
        mFooterHeightStatus = ta.hasValue(R.styleable.SmartLayout_srlFooterHeight) ? DimensionStatus.XmlLayoutUnNotify : mFooterHeightStatus;
        ...
        int accentColor = ta.getColor(R.styleable.SmartLayout_srlAccentColor, 0);
        int primaryColor = ta.getColor(R.styleable.SmartLayout_srlPrimaryColor, 0);
        if (primaryColor != 0) {
            if (accentColor != 0) {
...
//                mLastTouchY = touchY;
    ...
    protected void setStateDirectLoding() {
        if (mState != RefreshState.Loading) {
            ...
            if (mRefreshFooter != null) {
                mRefreshFooter.onStartAnimator(SmartLayout.this, mFooterHeight, mFooterExtendHeight);
            }
            if (mLoadmoreListener != null) {
                mLoadmoreListener.onLoadmore(SmartLayout.this);
            }
            if (mOnMultiPurposeListener != null) {
                mOnMultiPurposeListener.onLoadmore(SmartLayout.this);
    ...
    protected void setStateRefresing() {
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mRefreshListener != null) {
                    mRefreshListener.onRefresh(SmartLayout.this);
                }
                if (mRefreshHeader != null) {
                    mRefreshHeader.onStartAnimator(SmartLayout.this, mHeaderHeight, mHeaderExtendHeight);
                }
                if (mOnMultiPurposeListener != null) {
                    mOnMultiPurposeListener.onRefresh(SmartLayout.this);
...
//        }
    ...
    @Override
    public SmartLayout setFooterHeight(float heightDp) {
        return setFooterHeightPx(DensityUtil.dp2px(heightDp));
    }

    @Override
    public SmartLayout setFooterHeightPx(int heightPx) {
    ...
    @Override
    public SmartLayout setHeaderHeight(float heightDp) {
        return setHeaderHeightPx(DensityUtil.dp2px(heightDp));
    }

    @Override
    public SmartLayout setHeaderHeightPx(int heightPx) {
    ...
    @Override
    public SmartLayout setDragRate(float rate) {
        this.mDragRate = rate;
        return this;
    }
     ...
     */
    @Override
    public SmartLayout setHeaderMaxDragRate(float rate) {
     ...
     */
    @Override
    public SmartLayout setFooterMaxDragRate(float rate) {
     ...
     */
    @Override
    public SmartLayout setHeaderTriggerRate(float rate) {
     ...
     */
    @Override
    public SmartLayout setFooterTriggerRate(float rate) {
     ...
     */
    @Override
    public SmartLayout setReboundInterpolator(Interpolator interpolator) {
     ...
     */
    @Override
    public SmartLayout setReboundDuration(int duration) {
     ...
     */
    @Override
    public SmartLayout setEnableLoadmore(boolean enable) {
     ...
     */
    @Override
    public SmartLayout setEnableRefresh(boolean enable) {
     ...
     */
    @Override
    public SmartLayout setEnableHeaderTranslationContent(boolean enable) {
     ...
     */
    @Override
    public SmartLayout setEnableFooterTranslationContent(boolean enable) {
     ...
     */
    @Override
    public SmartLayout setDisableContentWhenRefresh(boolean disable) {
     ...
     */
    @Override
    public SmartLayout setDisableContentWhenLoading(boolean disable) {
     ...
     */
    @Override
    public SmartLayout setEnableAutoLoadmore(boolean enable) {
     ...
     */
    @Override
    public SmartLayout setEnableOverScrollBounce(boolean enable) {
     ...
     */
    @Override
    public SmartLayout setEnablePureScrollMode(boolean enable) {
     ...
     */
    @Override
    public SmartLayout setEnableScrollContentWhenLoaded(boolean enable) {
     ...
     */
    @Override
    public SmartLayout setEnableLoadmoreWhenContentNotFull(boolean enable) {
     ...
     */
    @Override
    public SmartLayout setEnableOverScrollDrag(boolean enable) {
     ...
     */
    @Override
    public SmartLayout setEnableFooterFollowWhenLoadFinished(boolean enable) {
     ...
     */
    @Override
    public SmartLayout setRefreshHeader(RefreshHeader header) {
     ...
     */
    @Override
    public SmartLayout setRefreshHeader(RefreshHeader header, int width, int height) {
        if (header != null) {
            if (mRefreshHeader != null) {
     ...
     */
    @Override
    public SmartLayout setRefreshFooter(RefreshFooter footer) {
     ...
     */
    @Override
    public SmartLayout setRefreshFooter(RefreshFooter footer, int width, int height) {
        if (footer != null) {
            if (mRefreshFooter != null) {
     ...
     */
    @Override
    public SmartLayout setOnRefreshListener(OnRefreshListener listener) {
     ...
     */
    @Override
    public SmartLayout setOnLoadmoreListener(OnLoadmoreListener listener) {
     ...
     */
    @Override
    public SmartLayout setOnRefreshLoadmoreListener(OnRefreshLoadmoreListener listener) {
        this.mRefreshListener = listener;
        this.mLoadmoreListener = listener;
        this.mEnableLoadmore = mEnableLoadmore || (!mManualLoadmore && listener != null);
        return this;
     ...
     */
    @Override
    public SmartLayout setOnMultiPurposeListener(OnMultiPurposeListener listener) {
     ...
     */
    @Override
    public SmartLayout setPrimaryColorsId(@ColorRes int... primaryColorId) {
     ...
     */
    @Override
    public SmartLayout setPrimaryColors(int... colors) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public SmartLayout setLoadmoreFinished(boolean finished) {
     ...
     */
    @Override
    public SmartLayout finishRefresh() {
     ...
     */
    @Override
    public SmartLayout finishLoadmore() {
     ...
     */
    @Override
    public SmartLayout finishRefresh(int delayed) {
     ...
     */
    @Override
    public SmartLayout finishRefresh(boolean success) {
        long passTime = System.currentTimeMillis() - mLastRefreshingTime;
     ...
     */
    @Override
    public SmartLayout finishRefresh(int delayed, final boolean success) {
            ...
            public void run() {
                if (mState == RefreshState.Refreshing) {
                    if (mRefreshHeader != null) {
                        ...
                        int startDelay = mRefreshHeader.onFinish(SmartLayout.this, success);
                        notifyStateChanged(RefreshState.RefreshFinish);
                        if (mOnMultiPurposeListener != null) {
     ...
     */
    @Override
    public SmartLayout finishLoadmore(int delayed) {
     ...
     */
    @Override
    public SmartLayout finishLoadmore(boolean success) {
        long passTime = System.currentTimeMillis() - mLastLoadingTime;
     ...
     */
    @Override
    public SmartLayout finishLoadmore(int delayed, final boolean success) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (mState == RefreshState.Loading) {
                    if (mRefreshFooter != null && mRefreshContent != null) {
                        int startDelay = mRefreshFooter.onFinish(SmartLayout.this, success);
                        if (startDelay == Integer.MAX_VALUE) {
                            return;
                        }
                        if (mIsBeingDragged) {
     ...
     */
    @Override
    public SmartLayout finishLoadmoreWithNoMoreData() {
        finishLoadmore(true);
     ...
     */
    @Override
    public SmartLayout resetNoMoreData() {
    ...
    protected class RefreshKernelImpl implements RefreshKernel {
        ...
        public RefreshLayout getRefreshLayout() {
            return SmartLayout.this;
        }

        @NonNull
        @Override
        public RefreshContent getRefreshContent() {
            return SmartLayout.this.mRefreshContent;
        }

        //<editor-fold desc="状态更改 state changes">
        public RefreshKernel setStatePullUpToLoad() {
            SmartLayout.this.setStatePullUpToLoad();
            return this;
        }

        public RefreshKernel setStateReleaseToLoad() {
            SmartLayout.this.setStateReleaseToLoad();
            return this;
        }

        public RefreshKernel setStateReleaseToRefresh() {
            SmartLayout.this.setStateReleaseToRefresh();
            return this;
        }

        public RefreshKernel setStatePullDownToRefresh() {
            SmartLayout.this.setStatePullDownToRefresh();
            return this;
        }

        public RefreshKernel setStatePullDownCanceled() {
            SmartLayout.this.setStatePullDownCanceled();
            return this;
        }

        public RefreshKernel setStatePullUpCanceled() {
            SmartLayout.this.setStatePullUpCanceled();
            return this;
        }

        public RefreshKernel setStateLoding() {
            SmartLayout.this.setStateLoding();
            return this;
        }

        public RefreshKernel setStateRefresing() {
            SmartLayout.this.setStateRefresing();
            return this;
        }

        @Override
        public RefreshKernel setStateLodingFinish() {
            SmartLayout.this.setStateLodingFinish();
            return this;
        }

        @Override
        public RefreshKernel setStateRefresingFinish() {
            SmartLayout.this.setStateRefresingFinish();
            return this;
        }

        public RefreshKernel resetStatus() {
            SmartLayout.this.resetStatus();
            return this;
        }
        //</editor-fold>
...
//        }
        ...
        public RefreshKernel moveSpinner(int spinner, boolean isAnimator) {
            SmartLayout.this.moveSpinner(spinner, isAnimator);
            return this;
        }

        public RefreshKernel animSpinner(int endSpinner) {
            SmartLayout.this.animSpinner(endSpinner);
            return this;
        }
